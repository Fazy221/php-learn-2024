...
<section class="container mx-auto p-4 mt-4">
      ...
      <div class="flex space-x-4 ml-4">
        ...
        <!-- Delete Form -->
        <form method="POST"> 
          <input type="hidden" name="_method" value="DELETE">  <!-- Adding Hidden input which'll be caught by router method in Framework/Router.php -->
        ...
        <div class="p-4">
          ...
          <ul class="my-4 bg-gray-100 p-4">
            ...
            <li class="mb-2">
              <strong>Location:</strong> <?= "{$listing->address}, {$listing->state}"  ?>
              <span
