...
$formatSalaryFn = fn($salary) => '$' . number_format($salary, 2);
...
function calculateAverageSalary($listings, $formatSalaryFn)
{
  $totalSalary = 0;
  ...
  return $formatSalaryFn($averageSalary);
}
?>
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="bg-green-100 rounded-lg shadow-md p-6 my-6">
      <h2 class="text-2xl font-semibold mb-4">Average Salary: <?= calculateAverageSalary($listings, $formatSalaryFn)  ?></h2>
    </div>
    <!-- Output -->
      ...
      <div class="md my-4">
        <div class="rounded-lg shadow-md <?= $index % 2 === 0 ? 'bg-blue-100' : 'bg-white' ?>">
          <div class="p-4">
            ...
            <ul class="mt-4">
              <li class="mb-2">
                <strong>Salary:</strong> <?= $formatSalaryFn($job['salary']); ?>
              </li>
              <li class="mb-2">
